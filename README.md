...
| Models     | Metric | <td rowspan="2">MixMamba (Ours)</td>|     | iTransformer (2023) |    | RLinear (2023) |          | PatchTST (2023) |          | Crossformer (2023) |          | TiDE (2023) |          | TimesNet (2023) |          | DLinear (2023) |          | SCINet (2022) |          | FEDformer (2022) |          | Stationary (2022) |          | Autoformer (2021) |          |
|------------|--------|-----------------|----------|---------------------|----------|----------------|----------|-----------------|----------|--------------------|----------|--------------|----------|-----------------|----------|-----------------|----------|----------------|----------|-------------------|----------|-------------------|----------|-------------------|----------|
|            |        | MSE             | MAE      | MSE                 | MAE      | MSE            | MAE      | MSE             | MAE      | MSE                | MAE      | MSE          | MAE      | MSE             | MAE      | MSE             | MAE      | MSE            | MAE      | MSE               | MAE      | MSE               | MAE      | MSE               | MAE      |
| **ETTm1**  | 96     | **0.318**       | **0.350**| 0.334               | 0.368    | 0.355          | 0.376    | <span style="color: blue;">0.329</span>         | _0.367_  | 0.404              | 0.426    | 0.364        | 0.387    | 0.338           | 0.375    | 0.345           | 0.372    | 0.418          | 0.438    | 0.379             | 0.419    | 0.386             | 0.398    | 0.505             | 0.475    |
